...
## RedLine Misuses
- **No “Act Vector” without “Orient & Align.”**  
- **No use of “altitude” to bypass accountable stakeholders.**  
- **No reordering/renaming phases in works claiming JPP.**  
- **No “JPPcompliant” claims for AIonly/automated workflows.**  
- **No training others unless operator readiness is met.**

---

## Operator Readiness Checklist
All **YES**:
1. Completed **3 live cycles** (adversarial, timecompressed, multiparty) with debriefs.  
2. Can resolve a **virtue conflict** (e.g., Prudence vs. Justice) before action.  
3. Demonstrated **WuWei timing** (disciplined nonaction) at least once.  
4. Agrees to **attribution** and **noderivatives**.  
5. Files brief debriefs: what JPP **prevented**, **enabled**, **where it strained**.

---

## Changelog
- **1.3b (Frozen Trunk)** — **[DATE]**: Canonical release (no structural changes anticipated).  
  Future sanctioned variants (if any) will be branchlabeled (e.g., `1.3b-RC` rapid-cycle, `1.3b-T` team/communal).
